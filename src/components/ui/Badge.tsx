...
const Badge = ({ label, varient = "neutral" }: Props) => {
  return (
    <span
      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ring-1 ring-inset ${styles[varient]}`}
    >
      {label}
    </span>
  );
